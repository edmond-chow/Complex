...
internal class Number : IEnumerable<double>
{
    ...
    public static Number NumberOuter(Number Union, Number Value)
    {
        ...
        VecValue[0] = 0;
        return NumberCross(VecUnion, VecValue) + Union[0] * VecValue - Value[0] * VecUnion;
    }
    public static Number NumberEven(Number Union, Number Value)
    {
        ...
        Number VecValue = Value;
        VecValue[0] = 0;
        return new Number(Union[0] * Value[0] - NumberDot(VecUnion, VecValue)) + Union[0] * VecValue + Value[0] * VecUnion;
    }
    public static Number NumberCross(Number Union, Number Value)
    {
        ...
        else if (Union.LongLength != Value.LongLength)
        {
            ...
            Number NewValue = Value;
            NewValue.Extend(NewSize);
            return NumberCross(NewUnion, NewValue);
        }
