...
#define OCTON_INTERFACE __attribute__((dllimport))
#if defined(DEBUG) || defined(X86) || defined(X64)
#define OCTON_FUNC_CALL CALL(__stdcall__)
#elif defined(RELEASE) || defined(X86) || defined(X64)
#define OCTON_FUNC_CALL CALL(__fastcall__)
#else
#define OCTON_FUNC_CALL
#endif
#define OCTON_FUNC_INSTANCE_CALL CALL(__thiscall__)
#elif defined(_MSVC_LANG)
#define CALL(c) c
#define OCTON_INTERFACE __declspec(dllimport)
#if defined(DEBUG) || defined(X86) || defined(X64)
#define OCTON_FUNC_CALL CALL(__stdcall)
#elif defined(RELEASE) || defined(X86) || defined(X64)
#define OCTON_FUNC_CALL CALL(__fastcall)
#else
#define OCTON_FUNC_CALL
#endif
#define OCTON_FUNC_INSTANCE_CALL CALL(__thiscall)
#else
#define CALL(c)
